...
しかし，公式のサポートツールは「３世代かつ牝馬継承のみ」と，配合チャートの検証が十分にできず，予定通りのクロスにならなかったり，危険な配合となる”事件”が後を絶ちません。<br>
...
PC，Android，iphone / iPadにおける詳細な導入方法は下記のサイトを各自で確認願います。<br>
...
<details><summary>配合チャート確認ツールとは</summary>，ゲーム内の配合掲示板のように「どの馬を，いつ掛け合わせるか」が一目で分かるツールです。<br>
...
### - <b>配合計画支援ツール</b> - ：
<details><summary>配合計画支援ツールとは</summary>，配合チャートに基づき「どの馬を，どのタイミングで」生産するかを決定する配合計画を支援するツールです。
...
また，ダビマスは牡牝の追加が多く，偶にオリジナル馬が実装されるため，血統検証にも工数を要します。<br>
